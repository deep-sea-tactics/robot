...
export async function installColmap() {
	...
	const windowsInstallURL = 'https://github.com/colmap/colmap/releases/download/3.9.1/COLMAP-3.9.1-windows-cuda.zip';
	...
	const mainPipe = Readable.fromWeb(body as ReadableStream<any>)
		.pipe(new Transform({
