...
public class JInputJoystickTest {
    ...
    public void getAllControllersInfo()
    {
        ...
        for (Controller controllersList1 : controllersList) {
            System.out.println(controllersList1.getName());
        }
        ...
        for (Controller controllersList1 : controllersList) {            
            ...
            System.out.println("Type: " + controllersList1.getType().toString());
            // Get this controllers components (buttons and axis)
            Component[] components = controllersList1.getComponents();
