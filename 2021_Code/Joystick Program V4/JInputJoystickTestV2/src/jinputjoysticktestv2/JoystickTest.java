...
public class JoystickTest {
    ...
    double dividedNum = 0.9, maxNum = 50, minNum = 50;
    ...
    public int getmotorPercentage_RU(int xAxisPercentage, int yAxisPercentage, double hatSwitchVal, double dividedNum, double maxNum, double minNum) {
        int motor_RU = 0, motor_RUU = 0, motor_RUS = 0;
        //double dividedNum = 1.25;
        //if statement controls the side to side orientation
        if (Button1 == 1 && Button0 == 0) {
            if (xAxisPercentage < 30) {
                motor_RUS = (int) ((xAxisPercentage - 30) * 1);
            }
            if (xAxisPercentage > 70) {
                motor_RUS = (int) ((xAxisPercentage - 70) * 1);
            }
         
        
            if (yAxisPercentage < minNum) {
                motor_RUU = (int) ((yAxisPercentage - minNum) * dividedNum);
               
            }
            if (yAxisPercentage > maxNum) {
                motor_RUU = (int) (((yAxisPercentage - maxNum) * dividedNum));
                
            }
        

        pRUMotorVal = (int) ((motor_RUU + motor_RUS) * 0.5);
        }
        ...
        //System.out.println("RU: " + pRUMotorVal + " " + motor_RU);
        return motor_RU;
    ...
    public int getmotorPercentage_LU(int xAxisPercentage, int yAxisPercentage, double hatSwitchVal, double dividedNum, double maxNum, double minNum) {
        int motor_LU = 0, motor_LUU = 0, motor_LUS = 0;
        //double dividedNum = 1.25;
        //controls the side to side orientation
        if (Button1 == 1 && Button0 == 0) {
            if (xAxisPercentage < 30) {
                motor_LUS = (int) ((xAxisPercentage - 30) * -1);
            } 
            else if (xAxisPercentage > 70) {
                motor_LUS = (int) ((xAxisPercentage - 70) * -1);
            ...
            if (yAxisPercentage < minNum) {
                motor_LUU = (int) ((yAxisPercentage - minNum) * dividedNum);

            } else if (yAxisPercentage > maxNum) {
                motor_LUU = (int) (((yAxisPercentage - maxNum) * dividedNum));
            }
        
        
        
        pLUMotorVal = (int) ((motor_LUU + motor_LUS) * 0.5);
    }
        if (Button9 == 1 && Button1 == 0) {
