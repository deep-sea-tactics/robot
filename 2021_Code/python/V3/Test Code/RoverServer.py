...
def processCommand(command):
    strValues = command.split(' ',11)

    if len(strValues) != 10:
        print('Unable to parse command into 10 values')
        return False       
    ...
    try:
        ...
        values[9] = int(strValues[9]) # Servo2
    except ValueError:
    ...
    if servo2 == 1:
        RoverServo.increaseServo2()
        
    if servo2 == -1:
        RoverServo.decreaseServo2()
